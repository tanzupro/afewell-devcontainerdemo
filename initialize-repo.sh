...
echo
echo Continue to create GitHub TAP GitOps Repo afewell-devcontainerdemo
echo     https://github.com/tanzupro/afewell-devcontainerdemo
echo
...
git add .
git commit -am "."
gh repo create afewell-devcontainerdemo --private
git remote add origin https://github.com/tanzupro/afewell-devcontainerdemo
git branch -M main
